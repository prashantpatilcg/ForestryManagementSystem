...
<style>
body{
  background-image:url("https://www.akamai.com/us/en/multimedia/images/home/2019/homepage-intro-background-desktop.png?imwidth=1366");  
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="exCollapsingNavbar">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a href="AdminHome" class="nav-link">Home</a></li>
...
<ul>
  <li><a href="./listOfProducts" class="alert-link">View Products</a></li>
    <li><a href="./createusermvc2" class="alert-link">Manager Section</a></li>
      <li><a href="./listOfContract" class="alert-link">View Contracts</a></li>
  <li><a href="./listOfOrder" class="alert-link">View Orders</a></li>
