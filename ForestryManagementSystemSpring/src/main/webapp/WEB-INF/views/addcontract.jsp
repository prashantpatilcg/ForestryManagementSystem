...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./addContract" >  
  <h1>Product Details</h1>  
 
    
     <div class="form-group">  
      <label for="name">Manager Id:</label>  
      <input type="number" name=managerid class="form-control"  placeholder="Manager id" size="4" required>  
    </div>
    ...
    <button type="submit" class="btn btn-primary">Aproove</button>  
  </form>  
</div>  
