...
<ul>
  <li><a href="./addproductmvc" class="alert-link">Add Product</a></li>
    <li><a href="productupdatemvc" class="alert-link">Modify Product</a></li>
  <li><a href="./deleteproductmvc" class="alert-link">Delete Product</a></li>
