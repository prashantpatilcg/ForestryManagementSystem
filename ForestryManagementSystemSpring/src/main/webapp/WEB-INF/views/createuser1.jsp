...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./createuser" >  
  <h1>Manager Details</h1>  
 
    
     <div class="form-group">  
      <label for="name">Manager name::</label>  
      <input type="text" name=username class="form-control"  placeholder="Manager name" size="4" required>  
    </div>
    ...
    <div class="form-group">  
     ...
     <input type="radio" class="form-control" name="role" value="Manager" required><center>Manager</center>
    </div>  
