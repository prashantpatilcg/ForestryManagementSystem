...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./modifyProduct" >  
  <h1>Product Details</h1>  
 
    
     <div class="form-group">  
      <label for="name">Product Id :</label>  
      <input type="number" name="productid" required  class="form-control"  placeholder="Enter your id" size="4">  
    </div>
    
    <div class="form-group">  
      <label for="name">Product name :</label>  
      <input type="text" name=productname required maxlength="20" class="form-control"  placeholder="Product name" size="4">  
    </div>
    
     <div class="form-group">  
      <label for="address">Product Description:</label>  
      <input type="text" required class="form-control" name=productdescription placeholder="Product desc" maxlength="100">  
    </div> 
    <div class="form-group">  
