...
<ul>
  <li><a href="./productmenumvc" class="alert-link">Products Section</a></li>
    <li><a href="./createusermvc" class="alert-link">Customer Section</a></li>
      <li><a href="./listOfContract" class="alert-link">View Contracts</a></li>
  <li><a href="./listOfOrder" class="alert-link">View Orders</a></li>
  <li><a href="./addContractmvc" class="alert-link">Add Contract</a></li>
  </ul>
</div>
