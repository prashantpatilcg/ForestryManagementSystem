...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./deleteProduct" >  
  <h1>Delete Product</h1>  
 
    
          <div class="form-group">  
      <label for="name">Product name :</label>  
      <input type="number" name=productid class="form-control"  placeholder="Product id" size="4">  
    </div>
