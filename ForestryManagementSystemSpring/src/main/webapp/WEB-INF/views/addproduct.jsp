...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./addproduct" >  
  <h1>Product Details</h1>  
 
    
     <div class="form-group">  
      <label for="name">Product name :</label>  
      <input type="text" name=productname maxlength="20" required class="form-control"  placeholder="Product name" size="4"   >  
    </div>
    
     <div class="form-group">  
      <label for="address">Product Description:</label>  
      <input type="text" class="form-control" name=productdescription maxlength="50" required placeholder="Product desc">  
    </div> 
    <div class="form-group">  
