...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./addorders" >  
  <h1>Product Details</h1>  
 
    
     <div class="form-group">  
      <label for="name">Customer Id:</label>  
      <input type="number" name=customerid required class="form-control"  placeholder="Enter Customer id" size="4">  
    </div>
    
     <div class="form-group">  
      <label for="address">Product Id:</label>  
      <input type="number" class="form-control" name=productid required placeholder="Product id">  
    </div> 
    <div class="form-group">  
      <label for="address">Quantity</label>  
      <input type="number" maxlength="3" class="form-control" name=quantity required placeholder="quantity">  
    </div>  
