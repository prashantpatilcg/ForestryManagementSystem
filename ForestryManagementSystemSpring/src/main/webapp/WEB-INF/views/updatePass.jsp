...
<div class="container">  
  <form class="form-container" name=addcustomer method=post action="./getPhoneno" >  
  <h3>Authenticate&nbsp;via&nbsp;mobile&nbsp;no.</h3>  
  
    
    <div class="form-group">  
      <label for="address">Contact No</label>  
      <input type="number" class="form-control" name=contactno placeholder="Contact No to update Password" required>  
    </div>
